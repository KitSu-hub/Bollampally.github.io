...
const Earnings = () => {
  ...
  const certifications = [
    {
      ...
      url:`${process.env.PUBLIC_URL}/pdf/Full Stack Web Development with MERN STACK & Gen AI 2025.pdf`
    },

    {
      ...
      url:`${process.env.PUBLIC_URL}/pdf/Getting Started with DevOps on AWS.pdf`
    },
    
    {
      ...
      url: `${process.env.PUBLIC_URL}/pdf/prompt-design-in-vertex-ai-skill-badge.png`
    },
    {
      id: 4,
      ...
      url:`${process.env.PUBLIC_URL}/pdf/Introduction to Generative AI - Art of the Possible.pdf`
    },
    {
      id: 5,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Develop applications with Azure OpenAI in Foundry Models.pdf`
    },
    {
      id: 6,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Step into Robotic Process Automation.png`
    },
    {
      id: 7,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Game Development using PyGame.png`
    },
    {
      id: 8,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Programming Essentials in C.pdf`
    },
    {
      id: 9,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Programming Essentials in Python.pdf`
    },
    {
      id: 10,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Algorithms, Data Collection, and Starting to Code.pdf`
    },
    {
      id:11,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Build a Face Recognition Application Using Python.png`
    },
    {
      id:12,
    ...
    },
    {
      ...
      url: `${process.env.PUBLIC_URL}/pdf/AWS Cloud Practitioner Essentials.pdf`
    },
    {
      id:14,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Docker Essentials.pdf`
    },
    {
      id:15,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Create Your Own ChatGPT-like Website with Open.pdf`
    },
    {
      id:16,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/Get started building with Power BI.pdf`
    },
    {
      id:17,
      ...
      url: `${process.env.PUBLIC_URL}/pdf/SpringBoot.png`
    },
    {
      id:18,
      title: "AI for All From Basics to Gen AI Practice",
      issuer: "NVIDIA",
      category: "ai",
      color: "purple-pink",
      date:"2025",
      icon: "🤖",
      skills: ["Generative AI", "Prompt Engineer", "Azure OpenAI"],
      url: `${process.env.PUBLIC_URL}/pdf/AI for All From Basics to Gen AI Practice.pdf`
    },
    {
      id:19,
    ...
    },
    {
      ...
      date:"2025",
      icon: "💼",
      skills: ["Tableau", "Pandas", "Excel", "Machine Learning", "Data Manipulation"],
      url: `${process.env.PUBLIC_URL}/pdf/Deloitte_Data_Analytics_Job_Simulation.pdf`
    }
  ...
  const categories = [
    ...
    { id: 'stimulation', name: 'Job Stimulations', icon: '💼' },
